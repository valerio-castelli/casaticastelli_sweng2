...
\subsection{Goal 9}
Goal 9: Passengers should be able to request rides.
...
\subsection{Goal 10}
Goal 10: Passengers should be able to register.
...
\subsection{Goal 11}
Goal 11: Registered passengers should be able to reserve rides in advance.

Requirements:
\begin{itemize}
\item The system should keep an association between a passenger profile and his reservations.
\item The system should provide a way for registered passengers to reserve a ride for a specific date and time.
...
\item The system should provide a way for registered passengers to review their active reservations.
\item The system should provide a way for registered passengers to delete a reservation.
...
Since Frank had flagged himself as available before accepting Samuel’s request and has not switched the available/unavailable toggle for the whole journey, the system moves his taxi into the last position of the computed zone’s queue. 