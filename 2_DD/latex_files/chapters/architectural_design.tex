...
\linebreak
	...
	\item requestTaxi(passengerId, passengerLocation, destination): N.B. THIS SHOULD BE CORRECTED implements the necessary operations to request a taxi.
	\end{itemize}
	...
	\begin{itemize}
	\item checkTaxiDriverLocation(currentLocation, meetingPoint, destinationPoint): verifies that the taxi driver has effectively reached both the meeting point and the destination point. N.B. TO BE CHECKED FOR CONSISTENCY
