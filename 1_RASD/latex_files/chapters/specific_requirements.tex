...
\item A taxi driver should be able to notify that he's terminated a ride only after the system has checked that the destination point has actually been reached within a given level of precision.
