...
\paragraph{Here we include a diagram which contains all the uses cases that are relevant for this system.}
\begin{landscape}
...
\paragraph{Here we include sketch of a possible class diagram for the system. 
...
\paragraph{Here we include a sequence diagram for the “request a taxi” operation. 
...
\paragraph{This state chart models the possible states in which a taxi can be inside the system and the transitions between them.
