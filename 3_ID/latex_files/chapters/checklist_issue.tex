...
\begin{enumerate}
	...
	\item \checklist{11} There are a number of single-line if statements that do not follow the convention. It would be very time consuming to enumerate them all, but at \codeline{1245}, \codeline{1254}, \codeline{1303}, \codeline{1307} there are a few examples of this behavior. 
\end{enumerate}
